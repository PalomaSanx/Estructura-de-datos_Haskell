...
public interface Pila<E>{
    ...
    */ 
    ...
    /**
    *   Saca un duplicado de la Pila.
    *	Devuelve un objeto del tipo Pila 
    *   concreto que se este empleando
    *   @return un clone de la pila	   
    */
    public Object clone();
       
    /**
    *   Pasa la pila a formato String.
    ...
    */
    ...
    /**
    *   Compara dos pilas elemento a elemento.
    *   No hace falta declarar el método en la interface. 
    *   Sólo para recordar que debe implementase.
