...
public interface Arbol<E>
{
	...
	/**
	 *
	 * Devuelve el Elemento contenido en el nodo raíz del árbol.
	 * En caso de que no exista tal elemento por estar vacío el 
	 * árbol, se lanza la excepción apropiada
	 ...
	 * @return true si el objeto es un árbol y coincide con this
         * elemento a elemento    
	 */
